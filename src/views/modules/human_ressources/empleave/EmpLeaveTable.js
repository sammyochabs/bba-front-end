...
const EmpLeaveTable = ({ leavesData, userID, emplist, leavelist }) => {
                ...
                <CDropdown className="m-1">
                  ...
                  <CDropdownMenu>
                    <CDropdownItem
                      ...
                      onClick={() => handleApprove(item.EmployeeLeaveID)}
                    >
                    ...
                    <CDropdownItem
                      hidden={item.status != 'New'}
                      onClick={() => handleCancel(item.EmployeeLeaveID)}
                    >
                    ...
                    <CDropdownItem
                      onClick={() => handleUpdate(item.EmployeeLeaveID, 'View')}
                    >
